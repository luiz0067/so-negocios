...
<tr>
    <td height="219" colspan="6" valign="top"><table width="1000px"  height="15px" border="0">
  <tr>
    <th scope="col" height="15"><form action="" method="get"><table width="1000px" height="15"border="0">
  <tr>
    <th width="493" scope="col">&nbsp;</th>
    <th width="249" height="15" class="texto_paginalocal" scope="col">Faça sua pesquisa pelo código ou nome do produto:</th>
  ...
  <tr>
    <td width="1000px"  height="198" valign="top" cellpadding="0" cellspacing="0"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="198">
  ...
  <tr>
    <td colspan="6" valign="top"><span class="texto_paginalocal">Você esta navegando em</span><span class="texto_destaque"> Home / Contato</span></td>
    </tr>
  <tr>
    ...
    <td colspan="4" align="left" valign="top"> <h2>:: Contato</h2></td>
  ...
  <tr>
    <td colspan="4"  align="center" valign="top" width="672"> <form id="form1" name="form1" method="post" action="enviar_contato.php">
      <table width="500" border="0"  >
      <tr align="left" valign="top">
        <td><table width="500" border="0" cellpadding="0" cellspacing="0" align="left">
            <tr>
            <td><p>Nome: </td>
            </tr>
          <tr>
          ...
          <tr>
           ...
           <tr>
           <td><input type="text" name="fonefax" /></td>
          </tr>
          <tr>
            <td><p>E-mail: </td>
            </tr>
          <tr>
            <td align="left" valign="middle"><input name="email" type="text" size="50" maxlength="50"/></td>
          </tr>
          <tr>
            <td><p>Mensagem: </td>
           </tr>
  ...
  <tr>
    <td width="672" align="center" valign="top">&nbsp;</td>
